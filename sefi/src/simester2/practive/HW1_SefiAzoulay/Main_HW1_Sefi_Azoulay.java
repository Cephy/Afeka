...
public class Main_HW1_Sefi_Azoulay {
	...
	public static void main (String[] args){
		...
		do{		
			...
			System.out.println("Press 3 to present all the customers in the bank (without duplicates) and each customer's payments");
	...
	public static int paymentToBank (Customer customer){
		...
		if(customer.getClass().getSimpleName().equals("GoldCustomer")){
			...
			return discount>GOLD_CUSTOMER_BAR ? GOLD_CUSTOMER_BAR :discount>PREFERRED_CUSTOMER_BAR ? discount: tmp.getAmountPurchases();			
		}
